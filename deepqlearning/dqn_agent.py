...
from deepqlearning.dqnarchitecture import QNetwork
import torch
...
class DQNAgent():
    ...
    def learn(self, experiences, gamma):
        ...
        Q_expected = self.qnetwork_behaviour(states).gather(1, actions)
        ...
        self.soft_update(self.qnetwork_behaviour, self.qnetwork_target, TAU)
