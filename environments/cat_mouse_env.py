...
# class CatMouseEnv_binary_reward():
#     """
#     An implementation of the pursuer-evader (cat-and-mouse)
#     reinforcement learning task.
#
...
#         self.nA = nA
#
#         self.action_space = spaces.MultiBinary(self.nA)
#         # note that our 'box' space has board_height * board_width + 2 dimensions
#         # the first (board_height * board_width) dimensions are like a one-hot encoding of the mouse position
#         # the final 2 dimensions are the row and col of the cat position
#         space_low = np.zeros(board_height * board_width + 2)
#         space_high = np.ones(board_height * board_width + 2)
